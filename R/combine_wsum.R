...
#' 
#' @param gmmlist list of \eqn{N} \code{gmmtools} S3 objects.
#' @param weight weight for each mixture model. If \code{NULL} (default), uniform weights are set.
#' 
#' @return a \code{gmmtools} object of a merged GMM.
#' 
#' @examples 
#' # -------------------------------------------------------------
...
#' grid.prob = gmmdensity(unifsum, grid.data)
